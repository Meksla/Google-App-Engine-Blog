...
%>
  ...
  <form class="form-horizontal" action="/subscribeservlet" method="POST">
  <fieldset>
    <legend>Subscribe for Email Updates</legend>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Email</label>
      <div class="col-lg-7">
        <input type="text" class="form-control" name="inputEmail" placeholder="iloveleague@email.com">
        <span class="help-block">Emails are sent out everyday at 5 PM Central Time with the latest posts</span>
      </div>
    </div>
    <div class="form-group">
      	<div class="col-lg-5 col-lg-offset-2">
       	<a href="/myblog.jsp" class="btn btn-default">Cancel</a>
        <button type="Subscribe" class="btn btn-primary">Submit</button>
    	</div>
    </div>
  	</fieldset>
	</form>
